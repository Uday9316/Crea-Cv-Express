      ...
      <div className="w-full lg:w-[1200px] grid grid-cols-1 lg:grid-cols-12 px-6 lg:px-32">
        ...
        <div className="col-span-12 px-4 py-6">
          ...
          <div className="w-full h-auto grid grid-cols-12" ref={resumeRef}>
            <div className="col-span-4 bg-gray-400 flex flex-col items-center justify-start">
              <div className="w-86 h-80 bg-gray-300 flex items-center justify-center">
                {!imageAsset.imageURL ? (
                  <React.Fragment>
                ...
                <div className="w-full">
                  ...
                  <div className="w-full pl-4 mt-3">
                    <input
                      ...
                      type="text"
                      readOnly="true"
                      className={`bg-transparent outline-none border-none text-base tracking-widest capitalize text-black-100 w-full ${
                        isEdit && "bg-[#1c1c1c]"
                      }`}
                    />
                    ...
                    <input
                      ...
                      type="text"
                      readOnly="true"
                      className={`bg-transparent outline-none border-none text-xs capitalize text-black-300 w-full ${
                        isEdit && "bg-[#383838]"
                      }`}
                    />
                  </div>
              ...
              <div className="w-full flex flex-col items-start justify-start mt-6 gap-6">
                <div className="w-full grid grid-cols-12">
                  <div className="col-span-3 w-full h-6 bg-black"></div>
                ...
                <div className="w-full grid grid-cols-12">
                  <div className="col-span-3 w-full h-6 bg-black"></div>
                  <div className="col-span-9">
                    <div className="w-full h-6 bg-[rgba(43,43,43,0.6)] px-3 flex items-center">
                      <p className="text-sm font-semibold text-gray-200">
                        Address
                      </p>
                    </div>
                    ...
                    <textarea
                      ...
                      className={`text-xs text-gray-200 mt-2 px-3  w-full  outline-none border-none ${
                        isEdit ? "bg-[#6a6a6a]" : "bg-transparent"
                      }`}
                      name="address"
            ...
            <div className="col-span-8 flex flex-col items-center justify-start py-6 bg-white">
              ...
              {/* title */}
              <div className="w-full  px-12 py-32 bg-gray-300">
